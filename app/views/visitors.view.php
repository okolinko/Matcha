...
<div class="flex-container">
	<div class="flex-liked"><a class="sim">Ваши посетители</a></div>

	<?php if (!empty($acaunt)): ?>
		<?php foreach ($acaunt as $acaunt_list):  ?>
			<div class="flex-elem">
				<img class="foto-form"  src="../../public/img/avatar/avatar<?php echo $acaunt_list['id_user']?>.png">
                <img id="ban" class="ban" <?php if ($acaunt_list['ban'] == 1) echo 'src="../../public/img/ban.png"'; else  echo 'src="../../public/img/ban_n.png"' ?> value="<?php echo $acaunt_list['id_user']?>">
