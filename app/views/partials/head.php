            ...
            function position(pos){
                ...
                for(i=0.001;i<4; i+=0.001)
                    for(j=0; j<misto.length;j++){
                        if((misto[j].lat<pos.coords.latitude+i && misto[j].lat>=pos.coords.latitude-i) && (misto[j].lon<pos.coords.longitude+i && misto[j].lon>=pos.coords.longitude-i)){ console.log( misto[j].name );
